 ...
 * OAuth handshake. Just implement {@link com.rcompton.rhsr.TwitterOAuthView.Listener}
 * and call {@link #start(String, String, String, boolean, com.rcompton.rhsr.TwitterOAuthView.Listener)
 * start()} method. The result of OAuth handshake is reported via
 * either of the listener's methods, {@link
 * com.rcompton.rhsr.TwitterOAuthView.Listener#onSuccess(com.rcompton.rhsr.TwitterOAuthView, twitter4j.auth.AccessToken) onSuccess()} or
 * {@link com.rcompton.rhsr.TwitterOAuthView.Listener#onFailure(com.rcompton.rhsr.TwitterOAuthView, com.rcompton.rhsr.TwitterOAuthView.Result)
 * onFailure()}.
 * </p>
 *
 * <p>
 ...
 * 
 * import twitter4j.auth.AccessToken;
 * import com.neovisionaries.android.twitter.{@link com.rcompton.rhsr.TwitterOAuthView};
 * import com.neovisionaries.android.twitter.{@link com.rcompton.rhsr.TwitterOAuthView.Result};
 * import android.app.Activity;
 * import android.os.Bundle;
 * import android.widget.Toast;
 *
 *
 * public class TwitterOAuthActivity extends Activity implements {@link com.rcompton.rhsr.TwitterOAuthView.Listener}
 * {
 ...
 * 
 * 
 *     private {@link com.rcompton.rhsr.TwitterOAuthView} view;
 ...
 *         view = new {@link com.rcompton.rhsr.TwitterOAuthView#TwitterOAuthView(android.content.Context) TwitterOAuthView}(this);
 * 
 *         setContentView(view);
 * 
 *         oauthStarted = false;
 ...
 *         view.{@link #start(String, String, String, boolean, com.rcompton.rhsr.TwitterOAuthView.Listener)
 *         start}(CONSUMER_KEY, CONSUMER_SECRET, CALLBACK_URL, DUMMY_CALLBACK_URL, this);
 *     }
 * 
 * 
 *     public void {@link com.rcompton.rhsr.TwitterOAuthView.Listener#onSuccess(com.rcompton.rhsr.TwitterOAuthView, twitter4j.auth.AccessToken)
 *     onSuccess}({@link com.rcompton.rhsr.TwitterOAuthView} view, {@link twitter4j.auth.AccessToken} accessToken)
 *     {
 ...
 *         // for later use.</span>
 *         showMessage("Authorized by " + accessToken.{@link twitter4j.auth.AccessToken#getScreenName() getScreenName()});
 *     }
 * 
 * 
 *     public void {@link com.rcompton.rhsr.TwitterOAuthView.Listener#onFailure(com.rcompton.rhsr.TwitterOAuthView, com.rcompton.rhsr.TwitterOAuthView.Result)
 *     onFailure}({@link com.rcompton.rhsr.TwitterOAuthView} view, {@link com.rcompton.rhsr.TwitterOAuthView.Result Result} result)
 *     {
...
public class TwitterOAuthView extends WebView {
     ...
     * #start(String, String, String, boolean, com.rcompton.rhsr.TwitterOAuthView.Listener) start} method.
     */
     ...
     * <li>Call {@link com.rcompton.rhsr.TwitterOAuthView.Listener#onSuccess(com.rcompton.rhsr.TwitterOAuthView, twitter4j.auth.AccessToken)
     *     onSuccess()} method of the {@link com.rcompton.rhsr.TwitterOAuthView.Listener listener} on the
     *     UI thread.
     * </ol>
     *
     * <p>
     * If an error occurred during the above steps, {@link
     * com.rcompton.rhsr.TwitterOAuthView.Listener#onFailure(com.rcompton.rhsr.TwitterOAuthView, com.rcompton.rhsr.TwitterOAuthView.Result)
     * onFailure()} of the {@link com.rcompton.rhsr.TwitterOAuthView.Listener listener} is called.
     * </p>
     *
     * <p>
